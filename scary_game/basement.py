class Basement():
    ...
    def explore_basement(self):
        ...
        You aren't sure if you saw a figure in the breif moment that the lights
        were on, or if it was just your imagination. Since this is the age of
        technology, everyone in your party gets out their cellphones to illuminate
        the room. The room is still shrouded in shadow, but it is just bright
