class Kitchen():
    ...
    def kitchen(self):
        ...
        if "Tom" in choice or "tom" in choice:
            ...
            Dead().dead("You start to lose vision and everything goes black. The last thing you feel is the far away sensation of Tom biting into your neck.")
        else:
            from dead import Dead
            print("""
            ...
            Dead().dead("""You wipe your mouth when you are satiated. Knowing that you can't go home you decide it best to sit and wait for the next
